...
class BasicBlockWOutput(nn.Module):
    ...
    def __init__(self, in_channels, channels, params, stride=1):
        ...
        if add_output:
            self.output = af.SDNOutput(input_size, self.expansion*channels, num_classes) 
...
class ResNet_DSN(nn.Module):
    def __init__(self, params):
        super(ResNet_DSN, self).__init__()
        ...
        self.layer_entropy_thresholds = None
